...
# - See here: https://masie_web.apps.nsidc.org/pub//DATASETS/NOAA/G02135/north/monthly/data/

# STEP 2: Get updated NRT SIC DATA AND GRID
# - see automated functions below

# STEP 3: run forecasts of upcoming September SIE
# - see automated functions below. 
...
#subprocess.check_call(['./getData/get_nrt_cdr_monthly.sh'])
